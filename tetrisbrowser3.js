...
scratch = scratch.op_assign(env._handlekey);
...
case "$L2":
scratch = env._boxes;
scratch = scratch.op_assign(new DataUnit(4, DATATYPES.DT_NUMBER));
scratch = env._bwidth;
scratch = scratch.op_assign(new DataUnit(25, DATATYPES.DT_NUMBER));
scratch = env._xoffset;
scratch = scratch.op_assign(new DataUnit(40, DATATYPES.DT_NUMBER));
scratch = env._yoffset;
scratch = scratch.op_assign(new DataUnit(40, DATATYPES.DT_NUMBER));
scratch = env._cwidth;
scratch = scratch.op_assign(new DataUnit(10, DATATYPES.DT_NUMBER));
scratch = env._cheight;
scratch = scratch.op_assign(new DataUnit(20, DATATYPES.DT_NUMBER));
scratch = env._startdelay;
scratch = scratch.op_assign(new DataUnit(800, DATATYPES.DT_NUMBER));
scratch = env._enddelay;
scratch = scratch.op_assign(new DataUnit(175, DATATYPES.DT_NUMBER));
scratch = env._preview_xpos;
scratch = scratch.op_assign(new DataUnit(13, DATATYPES.DT_NUMBER));
scratch = env._preview_ypos;
scratch = scratch.op_assign(new DataUnit(2, DATATYPES.DT_NUMBER));
tmp.push(retval);
tmp.push(params);
params = [];
...
scratch = scratch.op_assign(new DataUnit("Small Basic Tetris", DATATYPES.DT_STRING));
scratch = graphicswindow.height;
scratch = scratch.op_assign(new DataUnit(580, DATATYPES.DT_NUMBER));
scratch = graphicswindow.width;
scratch = scratch.op_assign(new DataUnit(700, DATATYPES.DT_NUMBER));
tmp.push(retval);
tmp.push(params);
params = [];
...
scratch = scratch.op_assign(env._h);
scratch = env._end;
scratch = scratch.op_assign(new DataUnit(0, DATATYPES.DT_NUMBER));
scratch = env._sessiondelay;
scratch = scratch.op_assign(env._startdelay);
case "$L15":
scratch = env._end;
...
case "$L19":
scratch = env._delay;
scratch = scratch.op_assign(env._sessiondelay);
scratch = env._thispiece;
scratch = scratch.op_assign(env._nextpiece);
scratch = env._template;
tmp.push(scratch);
tmp.push(retval);
tmp.push(params);
...
retval = tmp.pop();;
scratch = env._h;
scratch = scratch.op_assign(env._thispiece);
scratch = env._ypos;
scratch = scratch.op_assign(new DataUnit(0, DATATYPES.DT_NUMBER));
scratch = env._done;
scratch = scratch.op_assign(new DataUnit(0, DATATYPES.DT_NUMBER));
scratch = env._xpos;
scratch = scratch.op_assign(new DataUnit(3, DATATYPES.DT_NUMBER));
tmp.push(retval);
tmp.push(params);
params = [];
...
retval = tmp.pop();;
scratch = env._end;
scratch = scratch.op_assign(new DataUnit(1, DATATYPES.DT_NUMBER));
next = "$L26";
break;
case "$L26":
...
scratch = scratch.op_assign(env._delay);
case "$L32":
scratch = env._delayindex;
scratch = scratch.op_gt(new DataUnit(0, DATATYPES.DT_NUMBER));
tmp.push(scratch);
...
scratch = scratch.op_assign(new DataUnit(1, DATATYPES.DT_NUMBER).op_neg());
tmp.push(retval);
tmp.push(params);
params = [];
...
scratch = scratch.op_assign(retval);
scratch = env._template;
scratch = scratch.op_assign(new DataUnit("temptemplate", DATATYPES.DT_STRING));
scratch = env._rotation;
scratch = scratch.op_assign(new DataUnit("CW", DATATYPES.DT_STRING));
tmp.push(retval);
tmp.push(params);
params = [];
...
retval = tmp.pop();;
scratch = env._xposbk;
scratch = scratch.op_assign(env._xpos);
scratch = env._yposdelta;
scratch = scratch.op_assign(new DataUnit(0, DATATYPES.DT_NUMBER));
case "$L64":
scratch = env._yposdelta;
...
case "$L68":
scratch = env._basetemplate;
scratch = scratch.op_assign(env._template);
scratch = env._template;
scratch = scratch.op_assign(new DataUnit("rotatedtemplate", DATATYPES.DT_STRING));
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._h;
...
retval = tmp.pop();;
scratch = env._rotation;
scratch = scratch.op_assign(new DataUnit("COPY", DATATYPES.DT_STRING));
tmp.push(retval);
tmp.push(params);
params = [];
...
case "$L74":
scratch = env._xpos;
scratch = scratch.op_assign(new DataUnit(99, DATATYPES.DT_NUMBER));
next = "$L69";
break;
case "$L75":
scratch = env._xpos;
...
case "$L77":
scratch = env._xpos;
scratch = scratch.op_assign(env._xposbk);
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._h;
...
retval = tmp.pop();;
scratch = env._template;
scratch = scratch.op_assign(new DataUnit("", DATATYPES.DT_STRING));
next = "$L78";
break;
case "$L78":
next = "$L59";
...
scratch = env._xpos;
scratch = scratch.op_assign(env._preview_xpos);
scratch = env._ypos;
scratch = scratch.op_assign(env._preview_ypos);
scratch = env._h;
scratch = scratch.op_assign(env._nextpiece);
scratch = env._xoffsetbk;
scratch = scratch.op_assign(env._xoffset);
scratch = env._yoffsetbk;
scratch = scratch.op_assign(env._yoffset);
scratch = env._xoffset;
tmp.push(scratch);
scratch = env._xoffset;
tmp.push(scratch);
...
retval = tmp.pop();;
scratch = env._xoffset;
scratch = scratch.op_assign(env._xoffsetbk);
scratch = env._yoffset;
scratch = scratch.op_assign(env._yoffsetbk);
retval = new DataUnit();
next = fn.pop()[0];
break;
case "$L80":
...
scratch = scratch.op_assign(new DataUnit("Black", DATATYPES.DT_STRING));
...
scratch = scratch.op_assign(new DataUnit(1, DATATYPES.DT_NUMBER).op_neg());
scratch = env._i;
scratch = scratch.op_assign(env._boxes);
next = "$L153";
break;
case "$L153":
scratch = env._x;
...
case "$L185":
scratch = env._x;
scratch = scratch.op_assign(env._cwidth);
case "$L187":
scratch = env._x;
...
case "_setupcanvas":
scratch = graphicswindow.brushcolor;
scratch = scratch.op_assign(graphicswindow.backgroundcolor);
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._xoffset;
...
scratch = scratch.op_assign(new DataUnit(1, DATATYPES.DT_NUMBER));
scratch = graphicswindow.pencolor;
scratch = scratch.op_assign(new DataUnit("Pink", DATATYPES.DT_STRING));
scratch = new DataUnit(0, DATATYPES.DT_NUMBER);
retval = scratch;
scratch = env._x;
scratch.op_assign(retval);
...
retval = tmp.pop();;
scratch = graphicswindow.pencolor;
scratch = scratch.op_assign(new DataUnit("Lime", DATATYPES.DT_STRING));
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._xoffset;
...
scratch = scratch.op_assign(new DataUnit("False", DATATYPES.DT_STRING));
scratch = graphicswindow.fontname;
scratch = scratch.op_assign(new DataUnit("Comic Sans MS", DATATYPES.DT_STRING));
scratch = graphicswindow.fontsize;
scratch = scratch.op_assign(new DataUnit(16, DATATYPES.DT_NUMBER));
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._x;
...
scratch = scratch.op_assign(new DataUnit("Black", DATATYPES.DT_STRING));
scratch = graphicswindow.fontname;
scratch = scratch.op_assign(new DataUnit("Georgia", DATATYPES.DT_STRING));
scratch = graphicswindow.fontitalic;
scratch = scratch.op_assign(new DataUnit("True", DATATYPES.DT_STRING));
scratch = graphicswindow.fontsize;
scratch = scratch.op_assign(new DataUnit(36, DATATYPES.DT_NUMBER));
tmp.push(retval);
tmp.push(params);
params = [];
scratch = env._x;
...
scratch = scratch.op_assign(new DataUnit("False", DATATYPES.DT_STRING));
scratch = graphicswindow.fontsize;
scratch = scratch.op_assign(new DataUnit(32, DATATYPES.DT_NUMBER));
scratch = graphicswindow.fontname;
scratch = scratch.op_assign(new DataUnit("Impact", DATATYPES.DT_STRING));
scratch = graphicswindow.brushcolor;
scratch = scratch.op_assign(new DataUnit("Black", DATATYPES.DT_STRING));
tmp.push(retval);
tmp.push(params);
